...
def st_heatmap(ax, preds_list, current_frame_number):
    preds = preds_list[preds_list[:, 0] <= current_frame_number]
...
def st_display_bbox(ax, preds_list, current_frame_number):
    preds = preds_list[preds_list[:, 0] == current_frame_number]
    for bbox in preds:
...
def st_directional_arrows(ax, preds_list, current_frame_number):
    preds = preds_list[preds_list[:, 0] <= current_frame_number]    
