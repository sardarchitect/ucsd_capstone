...
def analysis_dashboard(video_dict, preds):
    ...
    with dash_c2:
        ...
        with st.form("dashboard_form"):
            ...
            radio_analysis_type = st.radio("Analysis Tye", options=["heatmap", "bounding_boxes", "directional_arrows"], key="radio_analysis_type", index=1)
    ...
    with dash_c1:
        ...
        if st.session_state["display_type"] == "interactive_plot":
            compute.show_interactive_plot(video_dict, preds)
